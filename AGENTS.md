...
- 新增、移动、重命名或删除 Skill 时，同步更新根 `README.md`、`skills/README.md`、对应分类的 `README.md` 以及相关 Skill 间的引用。
- 同步检查 `skills/coding/install-skills/SKILL.md` 中的分类扫描规则、预期数量和安装说明。
...
- `skills/` 下只存在约定的分类目录；每个 Skill 都直接位于某个分类目录下并包含 `SKILL.md`，不存在更深层的 Skill。
